...
__attribute__((section("__versions"))) = {
	...
	{ 0xbaf1536c, "smscore_start_device" },
	{ 0xe20625db, "usb_init_urb" },
	{ 0x54959776, "smscore_set_board_id" },
	{ 0xdb0dbe1c, "smscore_register_device" },
	{ 0xb81960ca, "snprintf" },
	...
	{ 0x37a0cba, "kfree" },
	{ 0xdbf98b73, "smscore_unregister_device" },
