...
__attribute__((section("__versions"))) = {
	...
	{ 0xe2d5255a, "strcmp" },
	{ 0x8d1b39e9, "snd_pcm_suspend_all" },
	...
	{ 0xa91fc571, "snd_pcm_new_stream" },
	{ 0x16305289, "warn_slowpath_null" },
	{ 0xbb72d4fe, "__put_user_1" },
	{ 0xc271c3be, "mutex_lock" },
	{ 0x1e6d26a8, "strstr" },
	{ 0x24f210bc, "snd_hwdep_new" },
	...
	{ 0x34b5635c, "snd_pcm_add_chmap_ctls" },
...
MODULE_INFO(srcversion, "DC523A71112927D430CD0BD");
